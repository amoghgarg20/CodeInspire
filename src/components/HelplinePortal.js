...
const HelplinePortal = () => {
  ...
  return (
    <div class='container helpline-portal py-5'>

      <h2 className='hp-header my-3'>{Language.HelplinePortalTitle}</h2>

      <button onClick ={changeLanguage}  className ="btn changeLanguage my-5">{Language.changeLanguagebtn}</button>
